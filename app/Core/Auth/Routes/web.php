...
Route::prefix('admin')->group(function () {
    ...
    Route::post('login', \App\Core\Auth\Controllers\LoginRequestController::class)->name('admin.login.request')->middleware('guest');
    ...
    Route::prefix('users')->middleware('auth')->group(function () {
        ...
        Route::post('/create', \App\Core\Auth\Controllers\CreateUserRequestController::class)->name('admin.users.create.request');
