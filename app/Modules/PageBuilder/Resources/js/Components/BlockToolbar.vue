<template>
    <div
        ...
        class="data-[selected=true]: data-[visible=true]: absolute top-1/2 left-2 z-90 hidden -translate-y-1/2 flex-col items-center justify-center space-y-1.5 rounded-md bg-elevated/75 p-2 opacity-0 transition-all data-[selected=true]:flex data-[selected=true]:opacity-100 data-[visible=true]:flex data-[visible=true]:opacity-100"
    >
